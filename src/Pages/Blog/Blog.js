        ...
        <div className="w-full px-5 lg:ml-10 lg:mr-5 text-left lg:w-9/12">
          ...
          <div id="state" className="text-justify">
            ...
            <div className="">
              ...
              <br /> Local state is perhaps the easiest kind of state to manage
              in React, considering there are so many tools built into the core
              ...
              reducer. The benefit of useReducer is that it provides a built-in
              way to perform a number of different state operations with the
              help of the reducer function, which makes it more dynamic overall
              than useState.
              <br />
              <br />
              <span className="text-lg text-cyan-100">Global (UI) state </span>
              ...
              from components lead to lots and lots of props. Redux is also
              ...
              the page. But then you need to display a loading spinner while you
              are waiting for the data. Then you need to handle errors and
              display them to the user as they arise. What happens when there is
              a network error? I need to hit my server every time my user visits
              the home page. I need to add useState and useEffect in every
              component I want to fetch my data.
              <br />
              <br />
          ...
          <div id="unit-test" className="text-justify">
            ...
            <div className="">
              ...
              <p className="my-3 text-cyan-100 text-lg">How unit tests work</p>A
              ...
              program as a whole. Once all of the units in a program have been
              found to be working in the most efficient and error-free manner
              possible, larger components of the program can be evaluated by
              means of integration testing. Unit tests should be performed
              frequently, and can be done manually or can be automated.
            </div>
          </div>
          ...
          <div id="diff" className="text-justify">
            ...
            <div className="">
              ...
              with the .vue extension contain HTML, CSS, and JavaScript so that
              all relevant code resides in one file.
              <br /> SFCs are the recommended way to organize code in Vue.js
              projects, especially larger ones. Tools such as Webpack or
              Browserify are required to transpile SFCs into working JavaScript
              code.
              ...
              template syntax with special directives to output reactive data
              and render multiple elements, among other things.
              <br />
